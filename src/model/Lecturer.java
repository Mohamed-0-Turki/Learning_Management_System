...
public class Lecturer extends Person {
    ...
    public boolean addQuestions(int courseID, Question[] questions, Exam exam) {
    ...
    public boolean addQuestions(int courseID, Question[] questions, Assignment assignment) {
    ...
    public boolean updateAssignment(int assignmentID, Assignment newAssignment) {
        super.setFilePath("database/assignments/assignment.txt");
        super.setFile();
        String line = super.search(0, Integer.toString(assignmentID));
        if (! line.equals("0")) {
            String[] examData = line.substring(1, line.length() - 1).split(", ");
            ...
            return super.update(assignmentID, line);
        }
        return false;
    }
